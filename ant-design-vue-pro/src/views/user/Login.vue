<template>
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          ...
          <a-form-item>
            <a-input
              ...
              <a-icon slot="suffix" :type="passwordType === 'password' ? 'eye-invisible' : 'eye'" @click="showPwd" />
            </a-input>
          </a-form-item>
      ...
      <div v-if="1===2" class="user-login-other">
        <span>其他登陆方式</span>
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
          username:{rules: [{ required: true, message: '请输入用户名!'},{validator: this.handleUsernameOrEmail}],'initialValue':'test'},
          password:{rules: [{ required: true, message: '请输入密码!',validator: 'click'}], 'initialValue':'111111'},
